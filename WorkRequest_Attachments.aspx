<%@ Page Title="" Language="C#" MasterPageFile="~/EditTabs.master" AutoEventWireup="true" CodeFile="WorkRequest_Attachments.aspx.cs" Inherits="WorkRequest_Attachments" Theme="Default" %>

<asp:Content ID="cpHeadTitle" ContentPlaceHolderID="headTitle" runat="Server">Work Request Attachments</asp:Content>
...
<asp:Content ID="cpBody" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
	...
	<script type="text/javascript">
		var _pageUrls;
		var _canEdit = false;
		var _selectedId = 0, _workRequestID = 0;
		...
		function btnDelete_click() {
			if (_selectedId == null || _selectedId == 0) {
				...
				if (confirm('Are you sure you want to delete: ' + selectedFileName + '?')) {
					PageMethods.DeleteAttachment(_workRequestID, _selectedId
