<%@ Title="" Language="C#" EnableViewState="false" EnableEventValidation="false" AutoEventWireup="true" CodeFile="MDGrid_WorkloadAllocation.aspx.cs" Inherits="MDGrid_WorkloadAllocation" Theme="Default" MasterPageFile="~/Grids.master" %>

<asp:Content ID="cpHeadTitle" ContentPlaceHolderID="headTitle" runat="Server">Master Data - Workload Allocation Grid</asp:Content>
...
<asp:Content ID="cpHeaderText" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="Server">
    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
        <tr>
            <td>
             Workload Allocation (<span id="spanRowCount" runat="server">0</span>)
            </td>
	...
	<script id="jsEvents" type="text/javascript">
        ...
        function loadChildGrid(td, id) {
            ...
            switch ($('#<%=this.ddlChildView.ClientID %> option:selected').val()) {
                case "0": // Status
                    url += 'MDGrid_WorkloadAllocation_Status.aspx';
                    url += '?WorkloadAllocationID=' + id;
                    break;
                case "1": // Contract
