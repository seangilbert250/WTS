<%@ Page Title="" Language="C#" MasterPageFile="~/Grids.master" AutoEventWireup="true" CodeFile="MDGrid_AOR_Type.aspx.cs" Inherits="MDGrid_AOR_Type" Theme="Default" %>

<asp:Content ID="cpHeadTitle" ContentPlaceHolderID="headTitle" runat="Server">Master Data - AOR Workload Type</asp:Content>
...
<asp:Content ID="cpHeaderText" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="Server">
        ...
        <tr>
            <td>
             AOR Workload Type (<span id="spanRowCount" runat="server">0</span>)
            </td>
...
<asp:Content ID="cpBody" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
	...
	<script id="jsEvents" type="text/javascript">
                ...
                if (direction.toUpperCase() == "SHOW") {
                    ...
                    $(sender).closest('tr').each(function () {
                        ...
                        td = $('td:eq(<%=(this.DCC == null 
							|| !this.DCC.Contains("AORWorkTypeName")) ? 0 : this.DCC["AORWorkTypeName"].Ordinal %>)', row)[0];
                        loadChildGrid(td, id);
                    });
                }
                else {
        ...
        //    url += _pageUrls.MasterData.Grid.Effort;
        //    url += '?EffortAreaID=' + id;
        ...
        function resizeFrame() {
            ...
            resizePageElement($('#<%=this.grdMD.ClientID %>').attr('id'), 0);
        }
        ...
        function initVariables() {
            try {
                ...
                if (_dcc[0] && _dcc[0].length > 0) {
                    ...
                    _idxID = +'<%=this.DCC == null ? 0 : this.DCC["AORWorkTypeID"].Ordinal %>';
                }
            } catch (e) {
