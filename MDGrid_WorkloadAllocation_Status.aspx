<%@ Title="" Language="C#" EnableViewState="false" EnableEventValidation="false" AutoEventWireup="true" CodeFile="MDGrid_WorkloadAllocation_Status.aspx.cs" Inherits="MDGrid_WorkloadAllocation_Status" Theme="Default" MasterPageFile="~/Grids.master" %>

<asp:Content ID="cpHeadTitle" ContentPlaceHolderID="headTitle" runat="Server">Master Data - Workload Allocation Grid - Status</asp:Content>
    	...
    	<script id="jsAJAX" type="text/javascript">
    	    ...
    	    function save() {
				...
				if (changedRows.length == 0) {
				    ...
				    PageMethods.SaveChanges(<%=_workloadAllocationID%>, json, save_done, on_error);
				}
            } catch (e) {
                ShowDimmer(false);
