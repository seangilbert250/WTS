    ...
    void formatColumnDisplay(ref GridViewRow row)
    {
        for (int i = 0; i < row.Cells.Count; i++)
        {
            if (i != DCC.IndexOf("WTS_SYSTEM_SUITEID")
                ...
                && i != DCC.IndexOf("Resources")
                && i != DCC.IndexOf("Workload Priority")
        ...
        row.Cells[DCC.IndexOf("WTS_SYSTEM_SUITE")].Style["width"] = "250px";
        row.Cells[DCC.IndexOf("DESCRIPTION")].Style["width"] = "250px";
        row.Cells[DCC.IndexOf("Abbreviation")].Style["width"] = "55px";
        row.Cells[DCC.IndexOf("Resources")].Style["width"] = "55px";
        row.Cells[DCC.IndexOf("Workload Priority")].Style["width"] = "145px";
