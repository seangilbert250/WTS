...
namespace WTS.Reports
{
    ...
    public class ReleaseDSEReport : ReportBase
    {
        ...
        public override bool ExecuteReport(Dictionary<string, string> reportParameters, int WTS_RESOURCEID, ref string errors, ref string outFileName, ref byte[] outFile)
        {
            ...
            string IncludeCDRLMetrics = reportParameters.ContainsKey("IncludeCDRLMetrics") ? reportParameters["IncludeCDRLMetrics"] : "";
            ...
            string IncludeSummaryMetrics = reportParameters.ContainsKey("IncludeSummaryMetrics") ? reportParameters["IncludeSummaryMetrics"] : "";
            string IncludeDSEIndex = reportParameters.ContainsKey("IncludeDSEIndex") ? reportParameters["IncludeDSEIndex"] : "";
            string IncludeLegends = reportParameters.ContainsKey("IncludeLegends") ? reportParameters["IncludeLegends"] : "";
                ...
                case "pdf":
                    ...
                    if (ds != null)
                    {
                        ...
                        if (CoverPage == "False")
                        {
                            ...
                            cryRpt.ReportDefinition.Sections["Section2"].SectionFormat.EnableSuppress = true;
                        }

                        if (IncludeSummaryMetrics == "False")
                        {
                            cryRpt.ReportDefinition.Sections["GroupHeaderSection6"].SectionFormat.EnableSuppress = true;
                        }
                        ...
                        if (IncludeSessionMetrics == "False")
                        {
                            ...
                            cryRpt.ReportDefinition.Sections["GroupHeaderSection16"].SectionFormat.EnableSuppress = true;
                        }
                        ...
                        if (IncludeCDRLMetrics == "False")
                        {
                            cryRpt.ReportDefinition.Sections["GroupHeaderSection15"].SectionFormat.EnableSuppress = true;
                            cryRpt.ReportDefinition.Sections["GroupHeaderSection12"].SectionFormat.EnableSuppress = true;
                        }
                        ...
                        if (IncludeLegends == "False")
                        {
                            cryRpt.ReportDefinition.Sections["GroupFooterSection3"].SectionFormat.EnableSuppress = true;
                            cryRpt.ReportDefinition.Sections["GroupFooterSection6"].SectionFormat.EnableSuppress = true;
                        }
