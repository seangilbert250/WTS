<%@ Page Title="" Language="C#" MasterPageFile="~/Grids.master" AutoEventWireup="true" CodeFile="MDGrid_RQMT_Description_Type.aspx.cs" Inherits="MDGrid_RQMT_Description_Type" Theme="Default" %>

<asp:Content ID="cpHeadTitle" ContentPlaceHolderID="headTitle" runat="Server">Master Data - RQMT Description Type</asp:Content>
...
<asp:Content ID="cpHeaderText" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="Server">
        ...
        <tr>
            <td>
             RQMT Description Type (<span id="spanRowCount" runat="server">0</span>)
            </td>
        ...
        function initVariables() {
            try {
                ...
                if (_dcc[0] && _dcc[0].length > 0) {
                    ...
                    _idxID = +'<%=this.DCC == null ? 0 : this.DCC["RQMTDescriptionTypeID"].Ordinal %>';
                }
            } catch (e) {
