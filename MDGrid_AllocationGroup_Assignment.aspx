<%@ Page Title="" Language="C#" MasterPageFile="~/Grids.master" AutoEventWireup="true" CodeFile="MDGrid_AllocationGroup_Assignment.aspx.cs" Inherits="MDGrid_AllocationGroup_Assignment" Theme="Default" %>
...
<asp:Content ID="cpBody" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
	...
	<script id="jsAJAX" type="text/javascript">
        ...
        function save_done(result) {
            try {
                ...
                if (saved > 0) {
                    msg = 'Successfully saved ' + saved + ' Work Area - Systems.';
                    if (opener && opener.refreshPage) {
                        opener.refreshPage();
                    }
                }
                if (failed > 0) {
                    msg += '\n' + 'Failed to save ' + failed + ' Work Area - Systems.';
                }
	...
	<script id="jsEvents" type="text/javascript">
		...
		function buttonDelete_click(){;
		    PageMethods.DeleteChild(_selectedId, save_done, on_error);
		}
		    ...
		    try {
		        ...
		        switch (textField.toUpperCase()) {
		            ...
		            case "ALLOCATION":
		                ...
		                textField = "ALLOCATION";
		                data = _Allocation_Unused;
		                break;
		        }
