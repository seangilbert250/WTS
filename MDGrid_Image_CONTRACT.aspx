<%@ Page Title="" Language="C#" MasterPageFile="~/Grids.master" AutoEventWireup="true" CodeFile="MDGrid_Image_CONTRACT.aspx.cs" Inherits="MDGrid_Image_CONTRACT" Theme="Default" %>

<asp:Content ID="cpHeadTitle" ContentPlaceHolderID="headTitle" runat="Server">Master Data - Image / Contracts Grid</asp:Content>
<asp:Content ID="cpHead" ContentPlaceHolderID="head" runat="Server"></asp:Content>
<asp:Content ID="cpHeaderText" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="Server">Image / Contracts (<span id="spanRowCount" runat="server">0</span>)</asp:Content>
	...
	<table cellpadding="0" cellspacing="0" style="float: right; padding-right: 2px;">
		<tr>
			<td>
                ...
                <input type="button" id="buttonDelete" value="Remove" disabled="disabled" />
			</td>
		</tr>
	</table>
</asp:Content>
