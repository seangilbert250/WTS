<%@ Page Title="" Language="C#" MasterPageFile="~/Grids.master" AutoEventWireup="true" CodeFile="MDGrid_WorkActivity_System.aspx.cs" Inherits="MDGrid_WorkActivity_System" Theme="Default" %>

<asp:Content ID="cpHeadTitle" ContentPlaceHolderID="headTitle" runat="Server">Master Data - Work Activity / Systems Grid</asp:Content>
		...
		function save() {
			try {
				...
				if (changedRows.length == 0) {
                    ...
                    PageMethods.SaveChanges('<%=_qfWorkItemTypeID %>', json, cvVal, save_done, on_error);
				}
			} catch (e) {
				ShowDimmer(false);
		...
		function save_done(result) {
			try {
				...
				if (saved > 0) {
				    ...
				    if (cvVal == "0") {msg += ' Work Activity - Systems.';}
