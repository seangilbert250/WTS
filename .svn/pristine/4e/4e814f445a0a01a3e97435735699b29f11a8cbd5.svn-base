...
<asp:Content ID="cpBody" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
	...
	<script id="jsEvents" type="text/javascript">
        ...
        function openSessionWorkTasks(ReleaseSessionID, ReleaseSession, ViewType) {
            var nWindow = 'SessionWorkTasks';
            var nTitle = 'Session Work Tasks';
            var nHeight = 585, nWidth = 850;
            var nURL = 'ReleaseSession_WorkTasks.aspx' + window.location.search + '&ReleaseSessionID=' + ReleaseSessionID + '&ReleaseSession=' + ReleaseSession + '&ViewType=' + ViewType;
