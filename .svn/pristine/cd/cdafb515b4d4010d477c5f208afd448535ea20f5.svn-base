...
svn copy "https://dev.cafdex.com:9443/svn/ITI_Folsom/LOCAL/WTS/branches/Production/" "https://dev.cafdex.com:9443/svn/ITI_Folsom/LOCAL/WTS/tags/Production/%tagName%" -m "Production Source from Production Branch for %d%at%t%%custom_DescriptionDetails%"
