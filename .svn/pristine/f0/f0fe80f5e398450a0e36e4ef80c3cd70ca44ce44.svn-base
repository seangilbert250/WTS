<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Grids.master" CodeFile="MDGrid_AOREstimation.aspx.cs" Inherits="MDGrid_AOREstimation" theme="Default"%>

<asp:Content ID="cpHeadTitle" ContentPlaceHolderID="headTitle" runat="Server">Master Data - AOR Estimation</asp:Content>
...
<asp:Content ID="cpHeaderText" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="Server">
    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
        <tr>
            <td>
             AOR Estimation (<span id="spanRowCount" runat="server">0</span>)
            </td>
...
<asp:Content ID="cpPageContentInfo" ContentPlaceHolderID="cphPageContentInfo" runat="Server">
	<table id="tableButtons" cellpadding="0" cellspacing="0" style="float: right; padding-right: 2px;">
		<tr>
			<td>
		...
		function initVariables() {
			try {
                ...
                if (_dcc[0] && _dcc[0].length > 0) {
                    ...
                    _idxID = parseInt('<%=this.DCC["AOREstimationID"].Ordinal %>');
                    _idxName = parseInt('<%=this.DCC["AOREstimationName"].Ordinal %>');
