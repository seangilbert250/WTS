<%@ Page Title="" Language="C#" MasterPageFile="~/Grids.master" AutoEventWireup="true" CodeFile="MDGrid_WorkType_Organization.aspx.cs" Inherits="MDGrid_WorkType_Organization" Theme="Default" %>

<asp:Content ID="cpHeadTitle" ContentPlaceHolderID="headTitle" runat="Server">Master Data - Resource Group/Organization Grid</asp:Content>
<asp:Content ID="cpHead" ContentPlaceHolderID="head" runat="Server"></asp:Content>
<asp:Content ID="cpHeaderText" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="Server">Resource Group/Organization (<span id="spanRowCount" runat="server">0</span>)</asp:Content>
<asp:Content ID="cpGridSetting" ContentPlaceHolderID="cphGridSettings" runat="Server">
	<table id="tableQuickFilters" cellpadding="0" cellspacing="0">
		<tr>
			<td style="padding-left: 5px;">Organization:
	...
	<script id="jsInit" type="text/javascript">
        ...
        function initVariables() {
            try {
                ...
                if (_dcc[0] && _dcc[0].length > 0) {
                    ...
                    _idxID = +'<%=this.DCC == null ? 0 : this.DCC["WorkType_ORGANIZATIONID"].Ordinal %>';
                }
            } catch (e) {
        ...
        $(document).ready(function () {
            ...
            if (_canEdit) {
                ...
                $('select').on('change keyup mouseup', function () { txt_change(this); });
