<%@ Page Title="" Language="C#" MasterPageFile="~/Grids.master" AutoEventWireup="true" CodeFile="WorkRequest_Comments.aspx.cs" Inherits="WorkRequest_Comments" Theme="Default" %>
...
<asp:Content ID="cpBody" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
	...
	<script type="text/javascript">
		...
		function exportToExcel() {
			...
			var nLocation = 'WorkRequest_Comments.aspx' + window.location.search;
		...
		function SaveComments() {
			...
			PageMethods.SaveComments(_workRequestID, changedComments, SaveComments_Done, OnError);
		}
		...
		function Delete(COMMENTID) {
			...
			if (confirm(confirmMsg)) {
				...
				PageMethods.DeleteComments(_workRequestID, arrCOMMENTIDsToDelete, Delete_Done, OnError);
			} else {
		...
		$(document).ready(function () {
			...
			_workRequestID = +'<%=this.WorkRequestID %>';
