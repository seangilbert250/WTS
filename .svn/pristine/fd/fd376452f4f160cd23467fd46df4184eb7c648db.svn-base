<%@ Page Title="" Language="C#" MasterPageFile="~/Grids.master" AutoEventWireup="true" CodeFile="MDGrid_PDD_TDR_Status.aspx.cs" Inherits="MDGrid_PDD_TDR_Status" Theme="Default" %>

<asp:Content ID="cpHeadTitle" ContentPlaceHolderID="headTitle" runat="Server">Master Data - Status Grid</asp:Content>
...
<asp:Content ID="cpHeaderText" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="Server">
        ...
        <tr>
            <td>
                Status (<span id="spanRowCount" runat="server">0</span>)
            </td>
...
<asp:Content ID="cpBody" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
	...
	<script id="jsEvents" type="text/javascript">
		...
		function lbEditWorkTypes_click(itemID) {
			...
			url = 'MDGrid_WorkType_Status.aspx?StatusID=' + itemID;
		...
		function initVariables() {
			try {
				...
				if (_dcc[0] && _dcc[0].length > 0) {
					...
					_idxName = parseInt('<%=this.DCC["Status"].Ordinal %>');
