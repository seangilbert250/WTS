...
<asp:Content ID="cpBody" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
        ...
        <iti_Tools_Sharp:Grid ID="gridNews" runat="server" AllowPaging="true" PageSize="50" FirstPageText="First" LastPageText="Last" PagerMode="NumericFirstLast" AllowResize="false"
    ...
    <script type="text/javascript">
        ...
        function row_click(row) {
            if ($(row).attr('newsId')) {
               ...
               // _attachmentId = $(row).attr('attachmentId');
                _newsTypeID = $(row).attr('newsTypeId');
        ...
        function btnEdit_onclick() {
            try {
                ...
                var openPopup = popupManager.AddPopupWindow('addEditNews', 'Edit News', 'Loading.aspx?Page=News_AddEdit.aspx?newsId=' + _selectedNewsId  + '&newsTypeId=' + _newsTypeID  +'&editType=edit' + '&random=' + Math.random(), 575, 700, 'PopupWindow', window.self);
        ...
        function btnAdd_onclick() {
            try {
                _selectedNewsId = -1;
                var openPopup = popupManager.AddPopupWindow('addEditNews', 'Edit News', 'Loading.aspx?Page=News_AddEdit.aspx?newsId=' + _selectedNewsId + '&editType=add' + '&random=' + Math.random(), 575, 700, 'PopupWindow', window.self);
        ...
        function resizeGrid() {
             <%=this.gridNews.ClientID %>.ResizeGrid();
        }
        ...
        $(document).ready(function () {
            ...
            $('#btnRefresh').click(function () { refreshGrid(); });
