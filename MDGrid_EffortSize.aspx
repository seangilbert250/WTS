<%@ Page Title="" Language="C#" MasterPageFile="~/Grids.master" AutoEventWireup="true" CodeFile="MDGrid_EffortSize.aspx.cs" Inherits="MDGrid_EffortSize" Theme="Default" %>

<asp:Content ID="cpHeadTitle" ContentPlaceHolderID="headTitle" runat="Server">Master Data - Size of Effort</asp:Content>
<asp:Content ID="cpHead" ContentPlaceHolderID="head" runat="Server"></asp:Content>
<asp:Content ID="cpHeaderText" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="Server">Size of Effort (<span id="spanRowCount" runat="server">0</span>)</asp:Content>
...
<asp:Content ID="cpBody" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
	...
	<script id="jsEvents" type="text/javascript">
		...
		function lbEditSizes_click(itemID) {
			var title = '', url = '';
			var h = 500, w = 800;

			title = 'Effort Size - Sizes';
			url = 'MDGrid_Effort.aspx?EfforSizeID=' + itemID;

			//open in a popup
			var openPopup = popupManager.AddPopupWindow('Effort', title, 'Loading.aspx?Page=' + url, h, w, 'PopupWindow', this);
			if (openPopup) {
				openPopup.Open();
			}
		}
		...
		function initVariables() {
			try {
				...
				if (_dcc[0] && _dcc[0].length > 0) {
					...
					_idxID = +'<%=this.DCC == null ? 0 : this.DCC["EffortSizeID"].Ordinal %>';
				}
			} catch (e) {
